...
async function loadApplications() {
    ...
    applications.forEach(app => {
        ...
        //display applications current status
        //app.notes displays a shortened preview of the application notes
        //clicking the preview opens a modal containing the complete notes
        row.innerHTML = `
            <td>${app.company}</td>
                ...
                >
                    ${
                        app.notes
                            ...
                            : "No notes" //displayed when no note exists
                    }
                </button>
            </td>    
            <td>
